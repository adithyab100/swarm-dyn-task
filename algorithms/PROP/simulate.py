...
def main_wrapper(n):
    return main([50,50,25,3, 6, 20000, 5], n)
...
if __name__ == "__main__":
    ...
    for i in range(9,-1,-1):
        file  = open("alg1_nobleEdit_1126/results/vary_task_rate_fastcomm.txt", 'a')
        print(i)
        results_prop = []
        results = []
        with Pool() as pool:
            params = [50,50,25,3,6,10000*(i+1), 5]
